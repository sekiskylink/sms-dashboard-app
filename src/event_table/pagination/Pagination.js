...
import { useQueryParams } from '../../views/events/useQueryParams'
...
export const Pagination = observer(({ page, pageCount, pageSize, total }) => {
    ...
    const queryParams = useQueryParams(store.defaulOrgUnit)
